...
namespace mod_linkedincert\output;
...
class renderer extends plugin_renderer_base {
     ...
     * Defer to template.
     *
     * @param \mod_linkedincert\output\verify_certificate_results $page
     * @return string html for the page
     */
    public function render_verify_certificate_results(verify_certificate_results $page) {
        $data = $page->export_for_template($this);
        return parent::render_from_template('mod_linkedincert/verify_certificate_results', $data);
    }
